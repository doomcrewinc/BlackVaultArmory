...
export function MobileHeader() {
  ...
  return (
    <>
      <header data-print-hide className="md:hidden sticky top-0 z-[450] flex items-center gap-3 h-14 px-4 border-b border-vault-border bg-vault-surface/95 backdrop-blur shrink-0">
        <button
