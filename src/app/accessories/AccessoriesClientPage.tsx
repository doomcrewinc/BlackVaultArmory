            ...
            <button
              ...
              className={
                selectedType === null
                  ...
                  : "border border-vault-border text-vault-text-muted rounded-full px-3 py-1 text-xs font-medium hover:border-vault-text-muted cursor-pointer transition-colors"
              }
            >
              All
            </button>
